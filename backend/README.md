...
## Project Structure
    ...
    ├── testapiautoteammemb_61239  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_61239`
...
2. Clone this repo and `cd testapiautoteammemb_61239`
